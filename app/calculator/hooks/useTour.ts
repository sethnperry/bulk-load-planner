    ...
    steps: [
      {
        ...
        message: "Tap here to choose your truck and trailer combination.",
        waitFor: "tap",
        position: "bottom",
      },
      {
        targetId: "tour-equipment-modal-combo",
        title: "Find your combo",
        message: "Search for your unit or select it from the list. If you need to couple a new combo, tap "Couple units".",
        waitFor: "tap",
        position: "bottom",
      },
      {
