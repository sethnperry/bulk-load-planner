"use client";
// app/calculator/cards/CardsSubTabs.tsx
//
...
const SUB_TABS = [
  { id: "terminals", label: "Terminals", href: "/calculator/cards" },
  { id: "badges", label: "Badges", href: "/calculator/cards/badges" },
  { id: "credentials", label: "Credentials", href: "/calculator/cards/credentials" },
] as const;

function activeSubTabFor(pathname: string | null): typeof SUB_TABS[number]["id"] {
  if (pathname === "/calculator/cards/badges") return "badges";
  if (pathname === "/calculator/cards/credentials") return "credentials";
  return "terminals";
}
